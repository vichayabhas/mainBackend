...
var camp_1 = __importDefault(require("./routes/camp"));
var admin_1 = __importDefault(require("./routes/admin"));
var randomthing_1 = __importDefault(require("./routes/randomthing"));
var subFrontend_1 = __importDefault(require("./routes/subFrontend"));
